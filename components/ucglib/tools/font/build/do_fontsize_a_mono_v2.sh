...
../bdfconv/bdfconv -b 2 ${BDF} -n ${IDENTIFIER}_mf -o ./ttf/ucg_font_${ARG3}_mf.c >/dev/null
../bdfconv/bdfconv -b 2 -m '32-127>32' ${BDF} -n ${IDENTIFIER}_mr -o ./ttf/ucg_font_${ARG3}_mr.c >/dev/null
../bdfconv/bdfconv -b 2 -m '32,42-58>42' ${BDF} -n ${IDENTIFIER}_mn -o ./ttf/ucg_font_${ARG3}_mn.c >/dev/null
#cp ${CFILE} ../../../src/.
